...
public abstract class ChartFactory {
    ...
    public static JFreeChart createBarChart(String title,
        ...
        CategoryPlot plot = plot1(categoryAxisLabel, valueAxisLabel, dataset, orientation, tooltips, urls);
		JFreeChart chart = new JFreeChart(title, JFreeChart.DEFAULT_TITLE_FONT,
                plot, legend);
        currentTheme.apply(chart);
        return chart;
	...
	private static CategoryPlot plot1(String categoryAxisLabel, String valueAxisLabel, CategoryDataset dataset,

 ...
 */
public class XYPlot extends IntermediateIntermediatePlot implements ValueAxisPlot, Pannable, Zoomable,
    ...
    public void addRangeMarker(int index, Marker marker, Layer layer,
            boolean notify) {
        addRangeMarkerExtracted(layer, index, marker, notify, foregroundRangeMarkers, backgroundRangeMarkers);
    }
    ...
    public void zoomRangeAxes(double factor, PlotRenderingInfo info,
        ...
        zoomRangeAxesExtracted(useAnchor, source, info, factor, rangeAxes, orientation);
    }

 ...
 * @since 1.0.11
 */
public class GradientXYBarPainter extends IntermediateXYBarPainter implements XYBarPainter, Serializable {
    ...
    private Rectangle2D[] splitVerticalBar(RectangularShape bar, double a,
            double b, double c) {
        return Utility.splitVerticalBarExtracted(bar, a, b, c);
    }
    ...
    private Rectangle2D[] splitHorizontalBar(RectangularShape bar, double a,
            double b, double c) {
        return Utility.splitHorizontalBarExtracted(bar, a, b, c);
    }
